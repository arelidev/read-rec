...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
    ...
    <dl>
		...
		<?php if ( ! empty( $displayDates = $additional_fields['Start/End Display'] ) ) : ?>
            <dt class="tribe-events-start-date-label"> <?php esc_html_e( 'Dates Available:', 'the-events-calendar' ); ?> </dt>
            <dd>
                <abbr class="tribe-events-abbr tribe-events-start-date published">
					<?php echo esc_html( $displayDates ); ?>
                </abbr>
            </dd>
		<?php endif; ?>
