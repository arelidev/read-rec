...
function widget_explore_facilities( $atts, $content = null ) {
    ...
    <div class="widget-explore-facilities grid-x <?= $atts['el_class']; ?>">
        ...
        <div class="small-order-2 medium-order-1 small-12 medium-12 large-8 cell" id="facilities-main">
            <div class="explore-facilities-main-slider">
				<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
                    <div class="explore-facilities-main-slider-slide" style="background-image: url(<?= get_the_post_thumbnail_url( get_the_ID(), 'full' ); ?>">
            ...
            <div class="grid-x grid-padding-x grid-padding-y hide-for-large">
                <div class="small-6 medium-6 cell text-center">
                    <button class="slick-prev-custom slick-custom widget-explore-facilities-main-slider-nav-prev">
                        <i class="far fa-chevron-left fa-lg"></i>
                    </button>
                </div>
                <div class="small-6 medium-6 cell text-center">
                    <button class="slick-next-custom slick-custom widget-explore-facilities-main-slider-nav-next">
        ...
        <div class="show-for-large medium-order-2 small-12 medium-12 large-4 cell explore-facilities-controls" data-sticky-container>
            <div class="sticky" data-sticky data-anchor="facilities-main">
                ...
                <img src="<?= get_template_directory_uri(); ?>/assets/images/hunterdon-county.svg" style="width: 100%;" class="hide">
            </div>
        </div>
    </div>
	<?php
