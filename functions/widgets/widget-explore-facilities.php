...
function widget_explore_facilities( $atts, $content = null ) {
    ...
    <div class="widget-explore-facilities grid-x <?= $atts['el_class']; ?>">
        ...
        <div class="small-12 medium-6 large-8 cell" id="facilities-main">
        ...
        <div class="small-12 medium-6 large-4 cell explore-facilities-controls" data-sticky-container>
            <div class="sticky" data-sticky data-anchor="facilities-main">
                ...
                <img src="<?= get_template_directory_uri(); ?>/assets/images/hunterdon-county.svg" style="width: 100%;">
            </div>
        </div>
    </div>
	<?php
